            ...
            <div className="Recipeonedetail-inner-flex">
              ...
              <div className="Recipeonedetail-inner-flex-con">
                ...
                <div className="Recipeonedetail-flex-part">
                  ...
                  <ul className="Recipedet-lists">
                    <li className="Recipedet-list">
                      1. In a blow, add 2 tbsp oil, salt, turmeric powder,
                      crushed black pepper, ajwain seeds, and baking soda
                      together in a bowl and mix well.
                    </li>
                    <li className="Recipedet-list">
                      2. Add the gram flour/ chickpea flour, add water little by
                      little and make a soft dough just like chapatti dough.
                      Knead the dough at least for 5-6 minutes and add 1 tbsp
                      oil; again knead the dough nicely and leave it aside for
                      15 to 20 minutes covering with kitchen towel or with a
                      clingfilm.
                    </li>
                    <li className="Recipedet-list">
                      3. After 15 to 20 minutes; take a some portion of the
                      dough and give them oval shape and place it on a greased
                      surface.(Note : Take flat surface like chopping board but
                      not very smooth, it helps when you remove the fafda from
                      the board.)
                    </li>
                    <li className="Recipedet-list">
                    ...
                    <li className="Recipedet-list">
                      5. Fry these strips over medium heat until crisp. Let them
                      cool.
                    </li>
                    <li className="Recipedet-list">
                      6. Now delicious fafda is ready to eat. Serve with spicy
                      green chilly chutney or chutney of grated papaya and fried
                      green chilly.
                    </li>
                  </ul>
                </div>
